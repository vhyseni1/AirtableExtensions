...
// Neutral palette: slate lead accent, then deep neutrals/jewels for initiatives.
const INITIATIVE_COLORS = ['#0F172A', '#14274E', '#0F766E', '#6D28D9', '#B45309', '#0E7490'];
...
function Donut({pct, size = 132, stroke = 13, color = '#0F172A', onClick, children}) {
