...
import { BlockInstallationPageElementCustomPropertyTypeForAirtableInterface } from '../types/airtable_interface';
 ...
 * @hook
 */
export function useCustomProperties(getCustomProperties) {
  const sdk = useSdk();
  ...
  const customPropertyValueByKey = hasError ? {} : Object.fromEntries(customProperties.map(property => [property.key, getCustomPropertyValue(sdk.base, globalConfig, property)]));
  return {
