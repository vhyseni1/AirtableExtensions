import { isEnumValue, entries, has, keys } from '../private_utils';
...
/** @hidden */
export class TableCore extends AbstractModel {
  /** @internal */
  ...
  _cellValuesByFieldIdOrNameToCellValuesByFieldId(cellValuesByFieldIdOrName, onGenerateIdForNewForeignRecord) {
    return Object.fromEntries(entries(cellValuesByFieldIdOrName).map(_ref => {
