...
import { type BaseData as BaseDataForBaseSdkMode, type BasePermissionData as BasePermissionDataForBaseSdkMode } from './base/types/base';
...
import { type BaseData as BaseDataForInterfaceSdkMode, type BasePermissionData as BasePermissionDataForInterfaceSdkMode } from './interface/types/base';
...
import { type AirtableInterface as AirtableInterfaceForBaseSdkMode, type BlockRunContext as BlockRunContextForBaseSdkMode, type SdkInitData as SdkInitDataForBaseSdkMode } from './base/types/airtable_interface';
import { type AirtableInterface as AirtableInterfaceForInterfaceSdkMode, type BlockRunContext as BlockRunContextForInterfaceSdkMode, type SdkInitData as SdkInitDataForInterfaceSdkMode } from './interface/types/airtable_interface';
...
import { type Mutation as MutationForBaseSdkMode, type PartialMutation as PartialMutationForBaseSdkMode } from './base/types/mutations';
import { type Mutation as MutationForInterfaceSdkMode, type PartialMutation as PartialMutationForInterfaceSdkMode } from './interface/types/mutations';
...
//# sourceMappingURL=sdk_mode.d.ts.map