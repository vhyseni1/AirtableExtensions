 ...
 */
export declare const ModeTypes: {
    /**
...
/** */
export type RecordColorMode = NoRecordColorMode | BySelectFieldRecordColorMode | ByViewRecordColorMode;
export declare const serialize: (mode: RecordColorMode) => string;
/**
...
export {};
//# sourceMappingURL=record_coloring.d.ts.map