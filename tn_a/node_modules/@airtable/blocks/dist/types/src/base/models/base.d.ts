...
import { type Aggregators } from './create_aggregators';
/**
 ...
 */
declare class Base extends BaseCore<BaseSdkMode> {
    /**
     ...
     * ```
     */
    checkPermissionsForCreateTable(name?: string, fields?: Array<{
        name?: string;
        type?: FieldType;
        options?: {
            [key: string]: unknown;
     ...
     * ```
     */
    hasPermissionToCreateTable(name?: string, fields?: Array<{
        name?: string;
        type?: FieldType;
        options?: {
            [key: string]: unknown;
     ...
     * ```
     */
    createTableAsync(name: string, fields: Array<{
        name: string;
        type: FieldType;
        options?: {
            [key: string]: unknown;
