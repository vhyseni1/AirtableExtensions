...
import RecordQueryResult, { type RecordQueryResultOpts, type RecordIdQueryResultOpts, type SingleRecordQueryResultOpts } from '../models/record_query_result';
 ...
 * @hook
 */
export declare function useRecordQueryResult(tableOrViewOrQueryResult: TableOrViewOrQueryResult | null, opts?: RecordQueryResultOpts): RecordQueryResult | null;
export {};
