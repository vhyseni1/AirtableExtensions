...
import { type RecordQueryResultOpts, type ViewMetadataForUpdate } from './record_query_result';
 ...
 */
declare class View extends AbstractModel<BaseSdkMode, ViewData, WatchableViewKey> {
    /**
     ...
     * @hidden
     */
    updateMetadataAsync(viewMetadata: ViewMetadataForUpdate): Promise<void>;
}
export default View;
