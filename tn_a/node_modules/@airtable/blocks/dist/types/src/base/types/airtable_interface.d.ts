...
import { type AirtableInterfaceCore, type AppInterface, type FieldTypeProviderCore, type FieldTypeConfig, type SdkInitDataCore } from '../../shared/types/airtable_interface_core';
...
import { type GroupData, type ViewColorsByRecordIdData, type ViewFieldOrderData, type GroupLevelData } from './view';
...
/** @hidden */
type FieldConfigValidationResult = {
    isValid: true;
} | {
    isValid: false;
    reason: string;
...
export interface FieldTypeProvider extends FieldTypeProviderCore {
    validateConfigForUpdate(appInterface: AppInterface, newConfig: FieldTypeConfig, currentConfig: FieldTypeConfig | null, fieldData: FieldData | null, billingPlanGrouping: string, opts?: UpdateFieldOptionsOpts): FieldConfigValidationResult;
