...
export default function withHooks<InjectedProps, Props extends InjectedProps, Instance>(Component: ((new (props: Props) => React.Component) & {
    displayName?: string;
}) | React.ComponentType<Props>, getAdditionalPropsToInject: (props: React.PropsWithoutRef<Omit<Props, keyof InjectedProps>>) => InjectedProps & {
    ref?: React.Ref<Instance>;
}): React.ForwardRefExoticComponent<Omit<Props, keyof InjectedProps> & React.RefAttributes<Instance>>;
