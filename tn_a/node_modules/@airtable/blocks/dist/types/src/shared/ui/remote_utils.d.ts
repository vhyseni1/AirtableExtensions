 ...
 */
export declare function loadCSSFromString(css: string): HTMLStyleElement;
/**
 ...
 */
export declare function loadCSSFromURLAsync(url: string): Promise<HTMLLinkElement>;
/**
 ...
 */
export declare function loadScriptFromURLAsync(url: string): Promise<HTMLScriptElement>;
//# sourceMappingURL=remote_utils.d.ts.map