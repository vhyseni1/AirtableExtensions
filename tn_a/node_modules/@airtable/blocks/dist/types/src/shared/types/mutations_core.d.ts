...
/** @hidden */
export declare const MutationTypesCore: Readonly<{
...
/** @hidden */
export type MutationCore = SetMultipleGlobalConfigPathsMutation | SetMultipleRecordsCellValuesMutation | DeleteMultipleRecordsMutation | CreateMultipleRecordsMutation;
/** @hidden */
export type PartialMutationCore = PartialSetMultipleGlobalConfigPathsMutation | PartialSetMultipleRecordsCellValuesMutation | PartialDeleteMultipleRecordsMutation | PartialCreateMultipleRecordsMutation;
/** */
...
export type PermissionCheckResult = SuccessfulPermissionCheckResult | UnsuccessfulPermissionCheckResult;
//# sourceMappingURL=mutations_core.d.ts.map