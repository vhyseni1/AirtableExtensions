...
import { type ObjectValues, type ObjectMap } from '../private_utils';
import { type SdkMode } from '../../sdk_mode';
import { type PermissionCheckResult } from '../types/mutations_core';
...
/** @hidden */
export declare abstract class TableCore<SdkModeT extends SdkMode, WatchableKeys extends string = WatchableTableKeyCore> extends AbstractModel<SdkModeT, SdkModeT['TableDataT'], WatchableTableKeyCore | WatchableKeys> {
    /**
